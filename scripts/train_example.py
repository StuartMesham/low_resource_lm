...
tokenizer_train_data_nguni = [
    'data/nchlt/isizulu/train.txt',
    'data/nchlt/isixhosa/train.txt',
    'data/nchlt/siswati/train.txt',
    'data/nchlt/isindebele/train.txt',
]

tokenizer_train_data_sotho_tswana = [
    'data/nchlt/sepedi/train.txt',
    'data/nchlt/setswana/train.txt',
    'data/nchlt/sesotho/train.txt',
]

tokenizer_train_data_tswa_ronga = [
    'data/nchlt/xitsonga/train.txt',
]

tokenizer_train_data_venda = [
    'data/nchlt/tshivenda/train.txt',
]
...
val_data = [
    (0, ['data/nchlt/isizulu/valid.txt']),
]

test_data = [
    (0, ['data/nchlt/isizulu/test.txt']),
]
